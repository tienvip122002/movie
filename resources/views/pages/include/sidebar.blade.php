          ...
          <div role="tabpanel" class="tab-pane active halim-ajax-popular-post">
             ...
             <div id="halim-ajax-popular-post" class="popular-post">
                ...
                <div class="item post-37176">
                   <a href="{{ route('movie', $value->slug) }}" title="{{ $value->title }}">
                      <div class="item-link">
                         <img src="{{ asset('uploads/movie/'.$value ->image) }}" class="lazy post-thumb" alt="{{ $value->title }}" title="{{ $value->title }}" />
  ...
  <aside id="sidebar" class="col-xs-12 col-sm-12 col-md-4">
     <div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
        ...
        <div class="tab-content" id="pills-tabContent">
         <div id="halim-ajax-popular-post-defaudt" class="popular-post">
            <span id="show_data_df"></span>
            </div>
