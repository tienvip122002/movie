                   ...
                   <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                      <div class="halim-server">
                         <ul class="halim-list-eps">
                           ...
                           <a href="{{ url('xem-phim/'.$sotap->movie->slug.'/tap-'.$sotap->episode) }}"><li class="halim-episode"><span class="halim-btn halim-btn-2 {{ $sotap->episode==$tapphim ? 'active' : '' }} halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="{{ $sotap->title }} - {{ $sotap->episode }} - Be Together - vietsub + Thuyết Minh" data-h1="{{ $sotap->title }} - {{ $sotap->episode }}">{{ $sotap->episode }}</span></li></a>
                           @endforeach
                         </ul>
                         <div class="clearfix"></div>
                      </div>
